...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-border bg-[var(--color-bg)] pt-16 pb-8 px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-16">
          ...
          <div className="col-span-2 lg:col-span-2">
            ...
            <div className="flex gap-4">
              <a
                className="text-gray-400 hover:text-rose-gold transition-colors duration-200"
          ...
          <div className="flex flex-col gap-4">
            ...
            <a
              className="text-gray-400 hover:text-rose-gold text-sm transition-colors duration-200"
              href="#features"
            >
              {t("featuresLink")}
            </a>
