              ...
              <div className="flex items-start gap-4 p-2">
                ...
                <div className="flex-1">
                  ...
                  <ol className="text-sm text-text-muted space-y-2 list-decimal list-inside mb-3">
                    <li>Quit the AI Gateway desktop app completely</li>
                    <li>
                    ...
                    <li>Relaunch the AI Gateway desktop app — it will start fresh setup</li>
                  </ol>
                </div>
              </div>
            </Card>
              ...
              <div className="flex items-start gap-4 p-2">
                ...
                <div className="flex-1">
                  ...
                  <ol className="text-sm text-text-muted space-y-2 list-decimal list-inside mb-3">
                    ...
                    <li>Relaunch the AI Gateway desktop app</li>
                  </ol>
                </div>
              </div>
            </Card>
