          ...
          {AUTO_COMBO_TEMPLATES.map((tpl) => (
            ...
            >
              ...
              <div className="flex items-center justify-between gap-2">
                <code className="font-mono text-sm text-text-main truncate">{tpl.name}</code>
                <span className="rounded bg-black/5 px-1.5 py-0.5 text-[10px] uppercase tracking-wide text-text-muted dark:bg-white/5 shrink-0">
                  {tpl.strategy}
                </span>
              </div>
