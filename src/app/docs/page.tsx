...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "AI Gateway Documentation",
    description:
      "Comprehensive docs for AI Gateway — setup, API, compression, deployment, and more.",
    type: "website",
  ...
  twitter: {
    ...
    title: "AI Gateway Documentation",
    description: "Comprehensive docs for AI Gateway",
  },
};
...
const featuredLinks = [
  {
    ...
    title: "Quick Start",
    icon: "rocket_launch",
    desc: "Get AI Gateway running in 3 minutes",
  },
  {
    href: "/docs/getting-started/auto-combo-guide",
    title: "Auto-Combo Guide",
    icon: "auto_awesome",
    desc: "Let AI Gateway pick the best AI for you",
  },
  {
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      <div className="text-center mb-16 mt-8">
        <h1 className="text-4xl font-bold text-fd-foreground mb-5">AI Gateway Documentation</h1>
