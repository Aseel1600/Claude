...
This project is indexed by GitNexus as **OmniRoute** (43248 symbols, 120524 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/OmniRoute/process/{processName}` — trace the full execution flow step by step
