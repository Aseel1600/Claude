...
| `/api/modality-bridge/video/`                | Video Bridge runtime probe and authenticated internal extraction broker — fixed FFmpeg/ffprobe invocations with bounded bytes/queue                                                                                                                   | No — spawn-capable            |
