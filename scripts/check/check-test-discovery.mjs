...
export const COLLECTORS = [
  ...
  {
    glob: "tests/unit/{api,auth,authz,build,cli,cli-helper,combo,compression,correctness,cors,db,db-adapters,docs,gamification,guardrails,lib,mcp,memory,providers,runtime,security,services,settings,shared,ui,usage}/**/*.test.ts",
