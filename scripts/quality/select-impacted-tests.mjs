...
const UNIT_SUBDIRS =
  "api|auth|authz|build|cli|cli-helper|combo|compression|correctness|cors|dashboard|db|db-adapters|docs|gamification|governor|guardrails|lib|mcp|memory|runtime|security|services|settings|shared|ui|usage|serial";
