...
if (!nativeCodexPassthrough && reactiveContextCompactionEnabled && estimatedTokens > threshold) {
      log?.info?.(
        "CONTEXT",
...
if (!nativeCodexPassthrough && reactiveContextCompactionEnabled && finalEstimatedInputTokens >= finalContextLimit && body) {
