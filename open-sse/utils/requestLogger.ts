...
type RequestLoggerOptions = {
  ...
  /** Server-derived from a recognized video carrier or successful bridge result, never prose. */
...
export async function createRequestLogger(
  ...
  const suppressTranscriptChunksIfNeeded = (
    descriptionContext: VideoTranscriptLogContext | boolean,
    ...values: unknown[]
  ): void => {
  ...
  if (options.enabled === false) {
    ...
    return {
      ...
      logClientRawRequest(_endpoint, body) {
        suppressTranscriptChunksIfNeeded(false, body);
      },
  ...
  return {
    ...
    logClientRawRequest(endpoint, body, headers = {}) {
      ...
      payloads.clientRawRequest = {
        ...
        body: cloneRequestBody(body, false),
      };
    },
