...
export const KNOWN_MODEL_PRICING: Record<string, ModelPricing> = {
  ...
  "claude-opus-4-8": { inputCostPer1M: 5.0, outputCostPer1M: 25.0, isFree: false },
  "claude-opus-4-7": { inputCostPer1M: 5.0, outputCostPer1M: 25.0, isFree: false },
  ...
  "gpt-5.6-sol": { inputCostPer1M: 4.0, outputCostPer1M: 20.0, isFree: false },
  "gpt-5.6-terra": { inputCostPer1M: 2.0, outputCostPer1M: 12.0, isFree: false },
  "gpt-5.6-luna": { inputCostPer1M: 0.2, outputCostPer1M: 1.2, isFree: false },
  "gemini-3.7-flash": { inputCostPer1M: 0.75, outputCostPer1M: 3.75, isFree: false },
  "gemini-3.6-flash": { inputCostPer1M: 0.75, outputCostPer1M: 3.75, isFree: false },
  "gemini-3.1-pro": { inputCostPer1M: 2.0, outputCostPer1M: 12.0, isFree: false },
  "gemini-2.5-flash": { inputCostPer1M: 0.3, outputCostPer1M: 2.5, isFree: false },
  "gemini-2.5-pro": { inputCostPer1M: 1.25, outputCostPer1M: 10.0, isFree: false },
