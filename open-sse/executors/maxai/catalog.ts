...
export const MAXAI_MODELS: MaxaiModelSpec[] = [
  // FAST
  { id: "gpt-5.6-luna", name: "GPT-5.6 Luna", contextLength: 1_050_000 },
  { id: "claude-haiku-4-5", name: "Claude Haiku 4.5", contextLength: 200_000 },
  { id: "gemini-3-1-flash-lite", name: "Gemini 3.1 Flash Lite", contextLength: 1_000_000 },
  ...
  // SMART
  { id: "gpt-5.6", name: "GPT-5.6", contextLength: 1_050_000 },
  ...
  // REASONING
  { id: "gpt-5.6-thinking", name: "GPT-5.6 Thinking", contextLength: 1_050_000, supportsReasoning: true },
  {
